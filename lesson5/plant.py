# Use the program from the previous lesson as a basis.
# Add the following features:
# - add different classes of machines.
# The name does not need to be transmitted,
# it is given in the class itself.
# - add the maximum number of machines at the factory.
# - add function "assamble", which will accept
# the car as a parameter and collect it.
